...
use super::{
    ...
    built_in_command_by_handler, recording, run_access_add, run_access_disable, run_access_enable,
    run_access_init, run_access_list, run_access_remove, run_access_status, run_auth_login,
    run_auth_logout, run_auth_status, run_client_list, run_config_get, run_config_path,
    run_config_profiles_diff, run_config_profiles_evaluate, run_config_profiles_explain,
    run_config_profiles_lint, run_config_profiles_list, run_config_profiles_resolve,
    run_config_profiles_show, run_config_profiles_switch, run_config_set, run_config_show,
    run_connect, run_doctor, run_external_plugin_command, run_follow, run_host, run_hosts,
    run_join, run_keymap_doctor, run_keymap_explain, run_logs_level, run_logs_path,
    ...
    run_sandbox_tail, run_sandbox_triage, run_server_bridge, run_server_gateway,
...
pub(super) async fn dispatch_built_in_command(
    ...
    match (handler, command) {
        ...
        ) => run_sandbox_bundle(&BundleSandboxOptions {
            target: sandbox,
