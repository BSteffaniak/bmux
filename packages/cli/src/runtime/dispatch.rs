...
use bmux_cli_schema::{
    ...
    RecordingEventKindArg, RemoteCommand, RemoteCompleteCommand, SandboxCommand,
    SandboxStatusArg, ServerCommand,
...
use super::{
    ...
    run_join, run_keymap_doctor, run_logs_level, run_logs_path, run_logs_profiles_delete,
