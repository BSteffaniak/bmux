...
wait-for pattern='sh-' timeout=20000
send-keys keys="printf 'RAW_HEX='; od -An -tx1 /tmp/bmux-paste-raw.bin | tr -d ' \\n'; echo\r"
wait-for pattern='RAW_HEX=726177207061737465' timeout=20000
...
wait-for pattern='WRAPPED_HEX=1b5b3230307e777261707065642070617374651b5b3230317e' timeout=20000
