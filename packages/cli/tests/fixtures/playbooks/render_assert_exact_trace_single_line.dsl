...
assert-render since='after_boot' min_frames=1 max_frames=1 full_frame=false max_full_frame_frames=0 max_rows_emitted=3 max_cells_emitted=114 expected_emitted_rows='1:0,1:1,1:2' expected_emitted_row_segments='1:0:0:38,1:1:0:38,1:2:0:38' expected_trace_ops='cursor:1:true,pane-row-full:1:0:38,pane-row-full:1:1:38,pane-row-full:1:2:38,pane-row-cache-skip:1:3,pane-row-cache-skip:1:4,pane-row-cache-skip:1:5'
