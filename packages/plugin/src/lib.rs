...
pub use render::{
    ...
    clip_render_text_run_to_rect, global_render_extension_registry, register_render_extension,
    registered_render_extensions, render_char_display_width_u16, render_single_display_cell_char,
