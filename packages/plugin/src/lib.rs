...
pub use render::{
    ...
    AttachInputModifiers, AttachInputPaneContext, AttachInputResult, AttachInputServiceInvocation,
    AttachRenderExtension, AttachVisualAdapter, AttachVisualAdapterOutput,
    AttachVisualAdapterRequest, AttachVisualCellRef, AttachVisualFrameView,
    AttachVisualProjectionResult, AttachVisualProjectionUpdate, AttachVisualSurfaceView,
    BorderGlyphs, ExtensionRect, RenderCell, RenderColor, RenderDamage, RenderExtensionContext,
    RenderExtensionLayer, RenderExtensionRegistry, RenderLayerItem, RenderLayerScene,
    RenderLayerSceneBuilder, RenderNamedColor, RenderOp, RenderSceneItem, RenderSceneItemKey,
    RenderSceneItemKind, RenderStyle, RenderSurfaceChrome, RenderSurfaceRole, RenderTextSpan,
    RenderUnderCell, TerminalGraphicFill, TerminalGraphicOverlay, TerminalRenderCapabilities,
    TerminalRgba, VisualAdapterRegistry, clip_render_text_run_to_rect,
