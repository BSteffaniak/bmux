...
pub use types::{
    ...
    AttachScrollbackPosition, CapturedHistoryAnchor, PaneRect, PaneRenderBuffer,
    PaneScrollbackView, PaneScrollbackViews, PaneScrollbackWindow, ScrollbackCapture,
    ScrollbackPin, ScrollbackViewportBase, TerminalGraphicsCache,
};
