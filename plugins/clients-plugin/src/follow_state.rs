...
//!
//! The clients plugin owns and constructs this type. The
//! `Arc<RwLock<FollowState>>` is registered into
//! [`bmux_plugin::PluginStateRegistry`] during the plugin's `activate`
//! callback; server and other plugins reach follow state through the
