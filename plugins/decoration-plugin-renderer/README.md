...
its internal state changes, it publishes a `DecorationScene` on the
...
- Subscribes to the client-side `bmux.scene/scene-protocol`
  broadcast channel and caches the latest `DecorationScene`.
