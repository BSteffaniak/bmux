...
pub(crate) struct DetectedTerminalProfile {
    pub(crate) terminal_id: String,
    pub(crate) font_families: Vec<String>,
    pub(crate) font_size_px: Option<u16>,
    pub(crate) background_opacity_permille: Option<u16>,
    #[serde(default)]
    pub(crate) cursor_defaults: CursorDefaults,
    #[serde(default)]
    pub(crate) palette_defaults: PaletteDefaults,
    pub(crate) source: String,
}

#[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, serde::Deserialize, Default)]
pub(crate) struct CursorDefaults {
    pub(crate) profile: Option<CursorDefaultProfile>,
    pub(crate) shape: Option<CursorDefaultShape>,
    pub(crate) blink: Option<CursorDefaultBlink>,
    pub(crate) color: Option<String>,
    pub(crate) solid_after_input_ms: Option<u32>,
    pub(crate) solid_after_output_ms: Option<u32>,
    pub(crate) solid_after_cursor_ms: Option<u32>,
    pub(crate) paint_mode: Option<CursorDefaultPaintMode>,
    pub(crate) text_mode: Option<CursorDefaultTextMode>,
    pub(crate) bar_width_pct: Option<u8>,
    pub(crate) underline_height_pct: Option<u8>,
}

#[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, serde::Deserialize, Default)]
pub(crate) struct PaletteDefaults {
    pub(crate) foreground: Option<String>,
    pub(crate) background: Option<String>,
    #[serde(default)]
    pub(crate) colors: Vec<PaletteColorEntry>,
}

#[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, serde::Deserialize)]
pub(crate) struct PaletteColorEntry {
    pub(crate) index: u8,
...
pub(crate) enum CursorDefaultProfile {
    Ghostty,
    Generic,
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, serde::Serialize, serde::Deserialize)]
#[serde(rename_all = "snake_case")]
pub(crate) enum CursorDefaultShape {
    Block,
    Bar,
    Underline,
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, serde::Serialize, serde::Deserialize)]
#[serde(rename_all = "snake_case")]
pub(crate) enum CursorDefaultBlink {
    On,
    Off,
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, serde::Serialize, serde::Deserialize)]
#[serde(rename_all = "snake_case")]
pub(crate) enum CursorDefaultPaintMode {
    Invert,
    Fill,
    Outline,
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, serde::Serialize, serde::Deserialize)]
#[serde(rename_all = "snake_case")]
pub(crate) enum CursorDefaultTextMode {
    SwapFgBg,
    ForceContrast,
}
...
pub(crate) fn detect_render_profile() -> Option<DetectedTerminalProfile> {
